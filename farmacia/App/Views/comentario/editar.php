<div class="container">
    ...
    <div class="col-md-9">
        ...
        <form action="http://<?php echo APP_HOST; ?>/comentario/atualizar" method="post" id="form_cadastro">
            <br />
            <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $viewVar['comentario']->getId(); ?>">

            <div class="form-group">
                <label for="nome">Nome</label>
                <input type="text"  class="form-control" name="nome" id="nome" value="<?php echo $viewVar['comentario']->getNome(); ?>" required>
            </div>
            <br />
            <div class="form-group">
                <label for="texto">Texto</label>
                <input type="text"  class="form-control" name="texto" id="texto" value="<?php echo $viewVar['comentario']->getTexto(); ?>" required>
            </div>
            <br />
