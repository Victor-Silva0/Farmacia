...
START TRANSACTION;
USE `farmacia`;
INSERT INTO `farmacia`.`vendas` (`idVenda`, `idCliente`, `dhVenda`, `valor`) VALUES (1, 1, '2023-12-01 22:44:18', 10);
INSERT INTO `farmacia`.`vendas` (`idVenda`, `idCliente`, `dhVenda`, `valor`) VALUES (2, 2, '2023-12-01 22:44:18', 20);
INSERT INTO `farmacia`.`vendas` (`idVenda`, `idCliente`, `dhVenda`, `valor`) VALUES (3, 4, '2023-12-01 22:44:18', 40);
...
START TRANSACTION;
USE `farmacia`;
INSERT INTO `farmacia`.`comentarios` (`id`, `nome`, `texto`, `data_comentario`) VALUES (1, 'Jose Luiz', 'Gostei do atendimento prestado pela equipe da FarmaTech. Nota MIIIIIIIL', '2023-12-01 22:44:18');
INSERT INTO `farmacia`.`comentarios` (`id`, `nome`, `texto`, `data_comentario`) VALUES (2, 'Maria Jose', 'Gostei do atendimento prestado pelo farmaceutico que me explicou tudo sobre o medicamento.', '2023-12-01 22:44:18');
INSERT INTO `farmacia`.`comentarios` (`id`, `nome`, `texto`, `data_comentario`) VALUES (3, 'Silvia Trajano', 'O caixa demorou muito no atendimento, tinham mais ou menos 20 pessoas na fila. Não gostei.', '2023-12-01 22:44:18');
INSERT INTO `farmacia`.`comentarios` (`id`, `nome`, `texto`, `data_comentario`) VALUES (4, 'Aparecido Godinho', 'A farmacia fica próxima ao centro médico, o que facilita a compra na hora que saimos de uma consulta.', '2023-12-01 22:44:18');
